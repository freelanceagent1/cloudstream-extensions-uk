# SVC_AnitubeinuaProvider.md

## Purpose
Anitubeinua - ????? ?????? ??????????? Cloudstream provider module delivering Ukrainian-localized streams for this source.

## Current Implementation Status
? **IMPLEMENTED** - Kotlin `MainAPI` provider module present.

## Implementation Details
- **Location**: AnitubeinuaProvider\src\main\kotlin\com\lagradost\AnitubeinuaProvider.kt; AnitubeinuaProvider\src\main\kotlin\com\lagradost\AnitubeinuaProviderPlugin.kt; AnitubeinuaProvider/build.gradle.kts
