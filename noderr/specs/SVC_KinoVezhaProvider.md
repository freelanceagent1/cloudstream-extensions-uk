# SVC_KinoVezhaProvider.md

## Purpose
KinoVezha - ?????? ???????/????????/???????????? ??????????? Cloudstream provider module delivering Ukrainian-localized streams for this source.

## Current Implementation Status
? **IMPLEMENTED** - Kotlin `MainAPI` provider module present.

## Implementation Details
- **Location**: KinoVezhaProvider\src\main\kotlin\com\lagradost\KinoVezhaProvider.kt; KinoVezhaProvider\src\main\kotlin\com\lagradost\KinoVezhaProviderPlugin.kt; KinoVezhaProvider/build.gradle.kts
