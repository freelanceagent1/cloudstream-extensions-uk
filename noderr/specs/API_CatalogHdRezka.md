# API_CatalogHdRezka.md

## Purpose
Fetch catalog/home/section listings (Movies/Series/Anime/etc.) with mirror fallback.
...
`	ext
// Define methods/endpoints/headers/parsing for API_CatalogHdRezka
`
