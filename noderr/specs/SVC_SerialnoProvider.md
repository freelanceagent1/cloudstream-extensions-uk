# SVC_SerialnoProvider.md

## Purpose
Serialno - ??????? ?????? ?????? ??????????? Cloudstream provider module delivering Ukrainian-localized streams for this source.

## Current Implementation Status
? **IMPLEMENTED** - Kotlin `MainAPI` provider module present.

## Implementation Details
- **Location**: SerialnoProvider\src\main\kotlin\com\lagradost\SerialnoProvider.kt; SerialnoProvider\src\main\kotlin\com\lagradost\SerialnoProviderPlugin.kt; SerialnoProvider/build.gradle.kts
