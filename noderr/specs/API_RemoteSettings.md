# API_RemoteSettings.md

## Purpose
Fetch remote settings (UA, app code, mirrors, trash codes) used by HdRezka provider.
...
`	ext
// Define methods/endpoints/headers/parsing for API_RemoteSettings
`
