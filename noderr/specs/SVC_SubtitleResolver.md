# SVC_SubtitleResolver.md

## Purpose
Attach subtitles from playback responses or detail pages to stream links.
...
`	ext
// Define methods/endpoints/headers/parsing for SVC_SubtitleResolver
`
