# SVC_UnimayProvider.md

## Purpose
Unimay - ????????? ?? ??????????? ????? ??????????? Cloudstream provider module delivering Ukrainian-localized streams for this source.

## Current Implementation Status
? **IMPLEMENTED** - Kotlin `MainAPI` provider module present.

## Implementation Details
- **Location**: UnimayProvider\src\main\kotlin\com\lagradost\UnimayProvider.kt; UnimayProvider\src\main\kotlin\com\lagradost\UnimayProviderPlugin.kt; UnimayProvider/build.gradle.kts
