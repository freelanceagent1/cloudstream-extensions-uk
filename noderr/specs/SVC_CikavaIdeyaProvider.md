# SVC_CikavaIdeyaProvider.md

## Purpose
CikavaIdeya - ??????? ??? ??????? '? ?? ????)' Cloudstream provider module delivering Ukrainian-localized streams for this source.

## Current Implementation Status
? **IMPLEMENTED** - Kotlin `MainAPI` provider module present.

## Implementation Details
- **Location**: CikavaIdeyaProvider\src\main\kotlin\com\lagradost\CikavaIdeyaProvider.kt; CikavaIdeyaProvider\src\main\kotlin\com\lagradost\CikavaIdeyaProviderPlugin.kt; CikavaIdeyaProvider/build.gradle.kts
