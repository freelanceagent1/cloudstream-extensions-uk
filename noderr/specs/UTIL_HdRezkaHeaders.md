# UTIL_HdRezkaHeaders.md

## Purpose
Build standard headers (UA, X-Hdrezka-Android-App, referer/origin) per mirror/request.
...
`	ext
// Define methods/endpoints/headers/parsing for UTIL_HdRezkaHeaders
`
