# API_TitleDetailHdRezka.md

## Purpose
Retrieve title metadata/poster/translator/episodes from detail pages.
...
`	ext
// Define methods/endpoints/headers/parsing for API_TitleDetailHdRezka
`
