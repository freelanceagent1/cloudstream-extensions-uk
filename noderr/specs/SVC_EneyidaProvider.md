# SVC_EneyidaProvider.md

## Purpose
Eneyida - ????/???????/??? ???????????, ????????????? ???? Cloudstream provider module delivering Ukrainian-localized streams for this source.

## Current Implementation Status
? **IMPLEMENTED** - Kotlin `MainAPI` provider module present.

## Implementation Details
- **Location**: EneyidaProvider\src\main\kotlin\com\lagradost\EneyidaProvider.kt; EneyidaProvider\src\main\kotlin\com\lagradost\EneyidaProviderPlugin.kt; EneyidaProvider/build.gradle.kts
