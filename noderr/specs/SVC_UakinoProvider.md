# SVC_UakinoProvider.md

## Purpose
Uakino - ?????? ?? ??????? ?????? ? ??????????? ???????? Cloudstream provider module delivering Ukrainian-localized streams for this source.

## Current Implementation Status
? **IMPLEMENTED** - Kotlin `MainAPI` provider module present.

## Implementation Details
- **Location**: UakinoProvider\src\main\kotlin\com\lagradost\UakinoProvider.kt; UakinoProvider\src\main\kotlin\com\lagradost\UakinoProviderPlugin.kt; UakinoProvider/build.gradle.kts
