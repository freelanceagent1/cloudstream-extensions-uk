# SVC_RemoteSettingsCache.md

## Purpose
Cache/apply remote settings (UA/appCode/mirrors/trash codes) with refresh.
...
`	ext
// Define methods/endpoints/headers/parsing for SVC_RemoteSettingsCache
`
