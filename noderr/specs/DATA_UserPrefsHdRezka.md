# DATA_UserPrefsHdRezka.md

## Purpose
Persist optional language/translator/mirror preferences for HdRezka flows.
...
`	ext
// Define methods/endpoints/headers/parsing for DATA_UserPrefsHdRezka
`
