# SVC_KinoTronProvider.md

## Purpose
KinoTron - ?????? ??????????? Cloudstream provider module delivering Ukrainian-localized streams for this source.

## Current Implementation Status
? **IMPLEMENTED** - Kotlin `MainAPI` provider module present.

## Implementation Details
- **Location**: KinoTronProvider\src\main\kotlin\com\lagradost\KinoTronProvider.kt; KinoTronProvider\src\main\kotlin\com\lagradost\KinoTronProviderPlugin.kt; KinoTronProvider/build.gradle.kts
