# SVC_HentaiUkrProvider.md

## Purpose
HentaiUkr - ????????????? ???? ??? ??????????? ????????? Cloudstream provider module delivering Ukrainian-localized streams for this source.

## Current Implementation Status
? **IMPLEMENTED** - Kotlin `MainAPI` provider module present.

## Implementation Details
- **Location**: HentaiUkrProvider\src\main\kotlin\com\lagradost\HentaiUkrProvider.kt; HentaiUkrProvider\src\main\kotlin\com\lagradost\HentaiUkrPlugin.kt; HentaiUkrProvider/build.gradle.kts
