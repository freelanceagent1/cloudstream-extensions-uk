# SVC_TeleportalProvider.md

## Purpose
Teleportal - ???????, ???, ????????????? ?????? Cloudstream provider module delivering Ukrainian-localized streams for this source.

## Current Implementation Status
? **IMPLEMENTED** - Kotlin `MainAPI` provider module present.

## Implementation Details
- **Location**: TeleportalProvider\src\main\kotlin\com\lagradost\TeleportalProvider.kt; TeleportalProvider\src\main\kotlin\com\lagradost\TeleportalProviderPlugin.kt; TeleportalProvider/build.gradle.kts
