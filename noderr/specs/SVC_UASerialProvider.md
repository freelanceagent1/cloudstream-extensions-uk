# SVC_UASerialProvider.md

## Purpose
UASerial - ??????? ??? Netflix/HBO/Disney/Amazon ??????????? Cloudstream provider module delivering Ukrainian-localized streams for this source.

## Current Implementation Status
? **IMPLEMENTED** - Kotlin `MainAPI` provider module present.

## Implementation Details
- **Location**: UASerialProvider\src\main\kotlin\com\lagradost\UASerialProvider.kt; UASerialProvider\src\main\kotlin\com\lagradost\UASerialProviderPlugin.kt; UASerialProvider/build.gradle.kts
