# API_PlaybackHdRezka.md

## Purpose
Resolve playback via cdn_movies/cdn_series POSTs and subtitle links.
...
`	ext
// Define methods/endpoints/headers/parsing for API_PlaybackHdRezka
`
