# SVC_PlaybackResolver.md

## Purpose
Decode trash codes, expand CDN hosts, pick translator/quality, emit ExtractorLinks.
...
`	ext
// Define methods/endpoints/headers/parsing for SVC_PlaybackResolver
`
