# UTIL_HdRezkaParsing.md

## Purpose
HTML parsing/selectors for catalog/detail (titles/posters/year/description/episodes).
...
`	ext
// Define methods/endpoints/headers/parsing for UTIL_HdRezkaParsing
`
