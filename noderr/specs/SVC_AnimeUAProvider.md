# SVC_AnimeUAProvider.md

## Purpose
AnimeUA - ???????????? ????? ????? ??????????? Cloudstream provider module delivering Ukrainian-localized streams for this source.

## Current Implementation Status
? **IMPLEMENTED** - Kotlin `MainAPI` provider module present.

## Implementation Details
- **Location**: AnimeUAProvider\src\main\kotlin\com\lagradost\AnimeUAProvider.kt; AnimeUAProvider\src\main\kotlin\com\lagradost\AnimeUAProviderPlugin.kt; AnimeUAProvider/build.gradle.kts
