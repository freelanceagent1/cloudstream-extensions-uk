# SVC_UAFlixProvider.md

## Purpose
UAFlix - ?????? ? ??????? Netflix ??????????? Cloudstream provider module delivering Ukrainian-localized streams for this source.

## Current Implementation Status
? **IMPLEMENTED** - Kotlin `MainAPI` provider module present.

## Implementation Details
- **Location**: UAFlixProvider\src\main\kotlin\com\lagradost\UAFlixProvider.kt; UAFlixProvider\src\main\kotlin\com\lagradost\UAFlixProviderPlugin.kt; UAFlixProvider/build.gradle.kts
