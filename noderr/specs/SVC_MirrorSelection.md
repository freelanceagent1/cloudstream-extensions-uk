# SVC_MirrorSelection.md

## Purpose
Choose best mirror with English preference and fallback rotation for catalog/search/detail/playback.
...
`	ext
// Define methods/endpoints/headers/parsing for SVC_MirrorSelection
`
